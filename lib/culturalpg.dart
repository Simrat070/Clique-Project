...
class Culturalpg extends StatefulWidget {
  const Culturalpg({super.key});

  @override
  State<Culturalpg> createState() => _CulturalpgState();
}

class _CulturalpgState extends State<Culturalpg> {
  @override
