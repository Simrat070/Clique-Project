...
class Acodingpg extends StatefulWidget {
  const Acodingpg({super.key});

  @override
  State<Acodingpg> createState() => _AcodingpgState();
}

class _AcodingpgState extends State<Acodingpg> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:Colors.black12,
      appBar: AppBar(
        title: Text('Edit Coding Club',
          style:TextStyle (
            fontSize:  18,
            letterSpacing: 1,
      ...
      body:SingleChildScrollView(
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: (){
                Navigator.pushNamed(context, 'editcodingclub');
              },
              child: Container(
