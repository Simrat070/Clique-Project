...
class Aepg extends StatefulWidget {
  const Aepg({super.key});

  @override
  State<Aepg> createState() => _AepgState();
}

class _AepgState extends State<Aepg> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:Colors.black12,
      appBar: AppBar(
        title: Text('Edit E-Cell ',
          style:TextStyle (
            fontSize:  18,
            letterSpacing: 1,
      ...
      body:SingleChildScrollView(
        child: Column(
          children: [
            GestureDetector(
              onTap: (){
                Navigator.pushNamed(context, 'editecell');
              },
              child: Container(
